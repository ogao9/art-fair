...
const roadmapSteps = [
    { desc: "Check out the featured designs with expert analysis", route: "/Feature" },
    ...
    { desc: "Discuss interesting designs on the Forum", route: "/Forum" },
        ...
        <>
            ...
            <div className="roadmap-container">
                <div className="roadmap-message">
                    ...
                    <p>A sample roadmap to guide you on your design journey</p>
                </div>
